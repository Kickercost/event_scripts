Feature: A new team is created in google drive
  ...
  Scenario: Admin creates a team that already exists
    When The google Drive folder of "Team 1" exists
    When The Admin creates the team "Team 1"
    Then The google Drive folder of "Team 1" exists

  Scenario: Admin creates a new user
    Given The Admin creates the team "Team 1"
    ...
    When the Admin assigns the user to "Team 1"
    Then The google drive folder for "Team 1" should have the user "Inc@kickercost.com" added with read rights
  ...
  Scenario: Admin creates a user that already exists for a team
    ...
    Scenario: Admin creates a team twice
      Given The Admin creates the team "Team 1"
      And The google Drive folder of "Team 1" exists
      Then The Admin creates the team "Team 1"
